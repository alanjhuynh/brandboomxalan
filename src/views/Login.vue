...
<!-- Login HTML -->
  <div class="container">
    ...
    <div class="container">
      ...
      <!-- Card is hidden until user clicks "continue as guest", fade transition when invoked -->
      <!-- Same format as Login card -->
...
export default {
  ...
  methods: {
    // Called when "Next" button is clicked in Login card. Form passes email and password, and calls firebase sign in function
    // Route to Chat page if successfully, passing displayName as prop
    login() {
    ...
    // Called when "Next" button is clicked in Guest card
    // Route to Chat page with name enter + "guest" title
    guestLogin() {
      if (this.name) {
    ...
    // Reveal guest card and scroll to it
    contGuest(){
      this.seen = true;
